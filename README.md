...
5. Create mockup of requested design using provided assets
6. Make it functional
7. Make it efficient
8. Make it pretty
9. First make a working desktop version, then provide adjustments to support mobile too
10. Utilise good coding practices at applicable steps
